...
module.exports = function (Posts) {
	Posts.getPostSummaryByPids = async function (pids, uid, options) {
		...
		const fields = ['pid', 'tid', 'toPid', 'url', 'content', 'sourceContent', 'targetRole', 'uid', 'timestamp', 'deleted', 'upvotes', 'downvotes', 'replies', 'handle', 'isEnglish', 'translatedContent'].concat(options.extraFields);
